...
const HeroSection = () => {
  function scrollToCalendly(event: React.MouseEvent<HTMLButtonElement, MouseEvent>): void {
        ...
        <div className="flex flex-col items-center justify-center max-w-4xl mx-auto">
          <div className="animate-fade-in">
            <span className="inline-block bg-saas-orange/10 text-saas-orange px-4 py-2 rounded-full text-sm font-medium mb-6 border border-saas-orange/20">
              Elite Growth Consulting - Limited Openings
            </span>
            
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 tracking-tight">
              Unlock Your Hidden Potential** With Our <span className="bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent">SaaS Solution</span>
            </h1>
